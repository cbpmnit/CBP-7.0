...
@TestPropertySource(properties = {
    ...
    "spring.datasource.hikari.connection-init-sql=CREATE SCHEMA IF NOT EXISTS identity; CREATE SCHEMA IF NOT EXISTS program; CREATE SCHEMA IF NOT EXISTS platform; CREATE SCHEMA IF NOT EXISTS finance; CREATE SCHEMA IF NOT EXISTS registration;"
})
class AdminStudentManagementControllerTest {
    ...
    void setUp() {
        ...
        Payment payment = Payment.builder()
                ...
                .paymentMode(com.cbp7.payment.entity.PaymentMode.ONLINE)
