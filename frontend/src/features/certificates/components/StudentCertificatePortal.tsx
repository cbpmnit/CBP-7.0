        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="p-4 rounded-xl bg-cyan-50 border border-cyan-200 text-cyan-900 text-xs flex items-start gap-2.5 max-w-xl mx-auto">
            ...
            <p className="leading-relaxed">
              <strong>Certificate Criteria:</strong> Certificates are automatically generated by the CBP system once you complete registration, clear fee payment, and achieve at least 75% attendance during the 4-day workshop.
            </p>
          </div>
        </div>
      </main>
