  ...
  return (
    <main className="py-6 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <form onSubmit={handleSaveProfile} className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              ...
              {isEditing && (
                <span className="text-[10px] font-extrabold text-amber-700 uppercase bg-amber-50 px-2 py-0.5 rounded border border-amber-200">
                  Editing Mode
                </span>
              )}
            </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
            ...
            <div>
              ...
              <p className="font-mono text-slate-900 bg-slate-50 p-2.5 rounded-xl border border-slate-150">
                {studentData.payment.paidAt
                  ? studentData.payment.paidAt.replace("T", " ").substring(0, 16)
                  : "-"}
              </p>
            </div>
          </div>
        ...
        {/* SECTION 4: Attendance & Certificate Status */}
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="flex items-center justify-between p-3 bg-purple-50/80 rounded-xl border border-purple-200">
                ...
                <span className="font-mono font-extrabold text-purple-950">
                  {(studentData.certificate as any).certificateNumber || studentData.certificate.certificateId}
                </span>
              </div>
            </div>
          </div>
