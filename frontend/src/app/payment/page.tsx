        ...
        <div className="w-full max-w-xl px-5 relative z-10 text-center">
          ...
          <Reveal delay={80}>
            <h1 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
              Payments <span className="gradient-text-cyan">Portal</span>
            </h1>
          </Reveal>
          <Reveal delay={120}>
            <p className="mt-4 text-sm leading-relaxed text-gray-300">
              The payment integration module is currently in development. Once active, students will be able to complete registrations transaction processing, verify statuses, and download invoice copies.
            </p>
          </Reveal>
          <Reveal delay={160}>
