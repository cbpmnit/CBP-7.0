...
export default function TopBanner() {
  return (
    <div className="top-banner-container w-full bg-black/95 text-white border-b border-cyan-500/30 relative z-50 overflow-hidden backdrop-blur-xl transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 md:py-4 flex items-center justify-between gap-3 md:gap-6 relative z-10">
        
        {/* Left Logo Container */}
        <div className="shrink-0">
          <div className="top-banner-logo-bg relative w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-black/80 rounded-full border border-cyan-500/40 shadow-[0_0_15px_rgba(0,240,255,0.3)] overflow-hidden group hover:scale-105 transition-transform duration-300">
        ...
        <div className="flex-1 text-center min-w-0 px-2">
          <div className="inline-flex items-center gap-2 rounded-full bg-cyan-500/10 border border-cyan-500/30 px-3 py-0.5 backdrop-blur-md">
            <span className="h-1.5 w-1.5 rounded-full bg-cyan-400 animate-pulse shadow-[0_0_6px_#00f0ff]" />
            <span className="text-[9px] md:text-xs font-sans font-medium tracking-widest text-cyan-300 uppercase">
              CBP 7.0 &middot; 2026 EDITION
            </span>
          </div>

          <h1 className="top-banner-title mt-1 text-lg sm:text-2xl md:text-3xl font-semibold tracking-tight text-white drop-shadow-[0_0_20px_rgba(0,240,255,0.3)]">
            Capacity Building Program
          </h1>

          <p className="top-banner-subtitle text-[9px] sm:text-xs md:text-sm font-medium text-cyan-400/90 mt-0.5 uppercase tracking-wider font-sans">
      ...
      <div className="top-banner-ticker-bg w-full bg-cyan-950/60 text-white flex items-center border-t border-cyan-500/20 h-8 md:h-9 overflow-hidden text-[10px] md:text-xs transition-colors duration-300">
        <div className="top-banner-ticker-badge bg-gradient-to-r from-cyan-400 to-blue-600 text-black font-semibold px-3 md:px-4 py-2 uppercase h-full flex items-center tracking-wider shrink-0 z-10 shadow-[4px_0_15px_rgba(0,240,255,0.4)]">
          Announcements
        </div>
